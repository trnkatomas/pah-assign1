(define (problem p5)
	...
	(:init
		...
		(wood-state w5 pile natural raw)
		(wood-state w6 pile natural raw)
		)		
	(:goal
		(and 
			...
			(wood-state w5 finished-pile red hexagon)
			(wood-state w6 finished-pile blue square)
			)
	)
